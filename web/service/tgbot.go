...
func (t *Tgbot) answerCallback(callbackQuery *tgbotapi.CallbackQuery) {
	...
	case "client_profile":
		t.SendMsgToTgbot(callbackQuery.From.ID, t.I18nBot("tgbot.commands.status"))
	case "onlines":
...
func (t *Tgbot) SendAnswer(chatId int64, msg string, isAdmin bool) {
	...
	numericKeyboardClient := tgbotapi.NewInlineKeyboardMarkup(
		tgbotapi.NewInlineKeyboardRow(
			tgbotapi.NewInlineKeyboardButtonData(t.I18nBot("tgbot.buttons.clientProfile"), "client_profile"),
